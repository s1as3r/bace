...
// a single-integer ecoding of a `DateTime`
typedef u64 DenseTime;

// packs `date_time` into a single `DenseTime` value.
DenseTime dense_time_from_date_time(DateTime date_time);

// unpacks `time` into a `DateTime`.
DateTime date_time_from_dense_time(DenseTime time);

// converts `time` (microseconds since the unix epoch) into a `DateTime`
DateTime date_time_from_micro_seconds(u64 time);

// converts `unix_time` into a `DateTime`
